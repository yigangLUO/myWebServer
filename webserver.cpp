...
void WebServer::sql_pool()
{
    ...
    string test_user = "root", test_passw = "123456", test_databaseN = "yourdb";

    m_connPool->init("127.0.0.1", m_user = test_user, m_passWord = test_passw, m_databaseName = test_databaseN, 3306, m_sql_num, m_close_log);
